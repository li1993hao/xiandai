<?php /* Smarty version Smarty-3.1.14, created on 2014-10-09 10:18:07
         compiled from "admin/tpl/othermanagement/publicitycolumn.html" */ ?>
<?php /*%%SmartyHeaderCode:21119331115434fb01af20c3-16554446%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6cbc39b89ec940957f2f9de2e06989ce6cabe8f2' => 
    array (
      0 => 'admin/tpl/othermanagement/publicitycolumn.html',
      1 => 1412821085,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '21119331115434fb01af20c3-16554446',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.14',
  'unifunc' => 'content_5434fb01b88961_22244713',
  'variables' => 
  array (
    'web_url' => 0,
    'mm' => 0,
...
<?php if ($_valid && !is_callable('content_5434fb01b88961_22244713')) {function content_5434fb01b88961_22244713($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html>
<head>
...
/common/admin/images/title_bg1.jpg">当前位置:宣传栏管理</TD></TR>
...
/manxiandai.php/Othermanagement/Publicitycolumn" >
        <tr>
        ...
        <tr>
            ...
            <td height="40" colspan="2">&nbsp;
                <input id="title" type="text" name="title" id="title" size="35" class="inputcss" value="<?php echo $_smarty_tpl->tpl_vars['detail']->value['pc_title'];?>
"/><font style="color:red;size:20px">(必填)</font></td>
        </tr>
        <tr>
            <td width="107" height="30"><div align="center">链接地址:</div></td>
            <td height="40" colspan="2">&nbsp;
                <input id="url" type="text" name="url" id="url" size="35" class="inputcss" value="<?php echo $_smarty_tpl->tpl_vars['detail']->value['pc_url'];?>
"/><font style="color:red;size:20px">(必填)</font></td>
        </tr>
        <tr>
            <td width="107" height="30"><div align="center">是否启用:</div></td>
            <td height="40" colspan="2">&nbsp;
                <input  type="checkbox" name="stop"  size="35" class="inputcss" <?php if ($_smarty_tpl->tpl_vars['detail']->value['stop']==1){?>checked="checked"<?php }?>" /></td>
        </tr>
        <tr>
...
" />
                <input type="hidden" name="pc_id"  value="<?php echo $_smarty_tpl->tpl_vars['detail']->value['pc_id'];?>
" />
