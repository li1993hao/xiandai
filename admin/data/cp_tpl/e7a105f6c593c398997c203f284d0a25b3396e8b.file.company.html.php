<?php /* Smarty version Smarty-3.1.14, created on 2014-10-16 12:56:21
         compiled from "admin\tpl\frontuser\company.html" */ ?>
<?php /*%%SmartyHeaderCode:20387543f4ff5e2c705-96667555%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e7a105f6c593c398997c203f284d0a25b3396e8b' => 
    array (
      0 => 'admin\\tpl\\frontuser\\company.html',
      1 => 1413394850,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '20387543f4ff5e2c705-96667555',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_543f4ff5efb342_29426807',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_543f4ff5efb342_29426807')) {function content_543f4ff5efb342_29426807($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html>
<head>
...
/manxiandai.php/frontuser/Getcompanyuserlist/state/"+verifyState+"/active/"+activeState+"/page/"+page;
		//alert(url);
		$.ajax({
			url:"<?php echo $_smarty_tpl->tpl_vars['web_url']->value;?>
/manxiandai.php/frontuser/Getcompanylist",
...
/manxiandai.php/frontuser/verifycompany/id/"+item.fu_id+"\">查看并审核</a>";
						}else{
							str +="<a class=\"company-href\" href=\"<?php echo $_smarty_tpl->tpl_vars['web_url']->value;?>
	...
	function setpw(id){
		...
		$("#setpw-meau-btnok").click(function(){
			...
			if (password == ""){
				...
				$.ajax({
					url:"<?php echo $_smarty_tpl->tpl_vars['web_url']->value;?>
/manxiandai.php/frontuser/Setpassword",
	...
	function changestatus(id){
		...
		var url= "<?php echo $_smarty_tpl->tpl_vars['web_url']->value;?>
/manxiandai.php/frontuser/Changestaus/id/"+id;
		alert(url);
		$.ajax({
			url:"<?php echo $_smarty_tpl->tpl_vars['web_url']->value;?>
/manxiandai.php/frontuser/Changestaus/id/"+id,
	...
	function delcompany(id){
		...
		var url= "<?php echo $_smarty_tpl->tpl_vars['web_url']->value;?>
/manxiandai.php/frontuser/Delcompany/id/"+id;
		//alert(url);
		$.ajax({
			url:"<?php echo $_smarty_tpl->tpl_vars['web_url']->value;?>
/manxiandai.php/frontuser/Delcompany/id/"+id,
