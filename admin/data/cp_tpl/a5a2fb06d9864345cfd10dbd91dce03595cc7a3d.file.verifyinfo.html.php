<?php /* Smarty version Smarty-3.1.14, created on 2014-10-16 13:59:21
         compiled from "admin\tpl\recruit\verifyinfo.html" */ ?>
<?php /*%%SmartyHeaderCode:27838543f5eb9861990-41793076%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a5a2fb06d9864345cfd10dbd91dce03595cc7a3d' => 
    array (
      0 => 'admin\\tpl\\recruit\\verifyinfo.html',
      1 => 1413394925,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '27838543f5eb9861990-41793076',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_543f5eb9b9d2c9_30664126',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_543f5eb9b9d2c9_30664126')) {function content_543f5eb9b9d2c9_30664126($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include 'E:\\wamp\\www\\xd\\xiandai\\been/Smarty/plugins\\modifier.truncate.php';
if (!is_callable('smarty_function_page')) include 'E:\\wamp\\www\\xd\\xiandai\\been/View/plugins\\function.page.php';
...
/manxiandai.php/recruit/infodetail/infoid/"+infoid,
			type:"post",
...
/common/upload/files/"+obj.json.data.info.file_link+"\">"+obj.json.data.info.file_name+"</a>";
	...
	$("#pass").live("click",function(){
		...
		$.ajax({
			url:"<?php echo $_smarty_tpl->tpl_vars['web_url']->value;?>
/manxiandai.php/recruit/passinfo/comid/"+com_id+"/infoid/"+infoid+"/state/"+state,
			type:"post",
			success:function(msg){
				var obj = eval('('+ msg +')');
				if(obj.json.state == 1){
	...
	$("#pop-reject-menu-btnok-add").live("click",function(){
		...
		$.ajax({
			url:"<?php echo $_smarty_tpl->tpl_vars['web_url']->value;?>
/manxiandai.php/recruit/rejectreason",
			type:"post",
...
/manxiandai.php/recruit/verifyinfo">
...
/manxiandai.php/recruit/verifyinfo/do/del/id/<?php echo $_smarty_tpl->tpl_vars['re']->value['cim_id'];?>
">删除</a>
			&nbsp;&nbsp;
...
<?php $_tmp1=ob_get_clean();?><?php echo smarty_function_page(array('info'=>$_smarty_tpl->tpl_vars['corplist']->value,'web_url'=>$_smarty_tpl->tpl_vars['web_url']->value,'url'=>"/manxiandai.php/recruit/verifyinfo/type/".$_tmp1),$_smarty_tpl);?>
