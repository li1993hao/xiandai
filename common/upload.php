...
if($_SERVER['SERVER_PORT'] == 80){
	$EditorUploadBaseUrl = "http://".$_SERVER['SERVER_NAME'].dirname($_SERVER['SCRIPT_NAME']);
}else {
	$EditorUploadBaseUrl = "http://".$_SERVER['SERVER_NAME'].":".$_SERVER['SERVER_PORT'].dirname($_SERVER['SCRIPT_NAME']);
}
