...
class CompanyController extends Controller{
	...
	public function modifyinfo(){
		...
		// print_r($companyInfo);
		 ...
		 echo $this->view->render("modifycominfo.html");
	}
	/**
	 * 修改密码
	 */
	...
	public function getmyjobfair(){
		...
		echo $this->view->render("myjobfair.html");
	}
	/**
	 * 删除招聘会
	 */
	...
	public function Pubjobfairinfo(){
		...
		echo $this->view->render("pubjobfairinfo.html");
	}
	...
	public function editjobfair(){
		...
		echo $this->view->render("editjobfair.html");
	}
	...
	public function getmycorpmsg(){
		...
		echo $this->view->render("mycorpmsg.html");
	}
	/**
	 * 删除招聘信息
	 */
	...
	public function Pubcorpmsg(){
		...
		echo $this->view->render("pubcorpmsg.html");
	}
	/**
	 * 修改招聘信息
	 */
	public function editcorpmsg(){
		...
		//var_dump($officelist);
		echo $this->view->render("editcorpmsg.html");
	}
	/**
	 * 添加职位
	 */
	...
	public function Studentinterestme(){
 		echo $this->view->render("studentinterstme.html");
	}
...
// 				}
	...
	public function Studentall(){
		...
		echo $this->view->render("studentall.html");
	}
