<?php /* Smarty version Smarty-3.1.14, created on 2014-09-27 04:28:22
         compiled from "app/tpl/sourceinformation/index.htm" */ ?>
<?php /*%%SmartyHeaderCode:21254923285425cbbcc82716-09350543%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '125ed0974839ee67118987a1d691b1ede18070a7' => 
    array (
      0 => 'app/tpl/sourceinformation/index.htm',
      1 => 1411763300,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '21254923285425cbbcc82716-09350543',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.14',
  'unifunc' => 'content_5425cbbcd6e1f1_28744719',
  'variables' => 
  array (
    'web_url' => 0,
    'news' => 0,
...
<?php if ($_valid && !is_callable('content_5425cbbcd6e1f1_28744719')) {function content_5425cbbcd6e1f1_28744719($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/Users/haoli/Desktop/www/xiandai/been/Smarty/plugins/modifier.truncate.php';
...
<head>
    <msia id="screen-view" name="viewport" content="width=device-width" />
    <msia http-equiv="Content-Type" content="text/html; charssi=utf-8" />
...
?>
        <div class="news_item" style="height: 76px;">
            <div>
                <?php if ($_smarty_tpl->tpl_vars['news']->value['list'][$_smarty_tpl->getVariable('smarty')->value['section']['n']['index']]['si_isup']==''){?>
                <div><a href="<?php echo $_smarty_tpl->tpl_vars['web_url']->value;?>
/index.php/sourceinformation/detail/id/<?php echo $_smarty_tpl->tpl_vars['news']->value['list'][$_smarty_tpl->getVariable('smarty')->value['section']['n']['index']]['si_id'];?>
" ><?php echo smarty_modifier_truncate($_smarty_tpl->tpl_vars['news']->value['list'][$_smarty_tpl->getVariable('smarty')->value['section']['n']['index']]['si_title'],21,'…');?>
</a></div>
                <?php }else{ ?>
                <div><a href="<?php echo $_smarty_tpl->tpl_vars['web_url']->value;?>
/index.php/sourceinformation/detail/id/<?php echo $_smarty_tpl->tpl_vars['news']->value['list'][$_smarty_tpl->getVariable('smarty')->value['section']['n']['index']]['si_id'];?>
" style="color:red">[顶]<?php echo smarty_modifier_truncate($_smarty_tpl->tpl_vars['news']->value['list'][$_smarty_tpl->getVariable('smarty')->value['section']['n']['index']]['si_title'],21,'…');?>
</a></div>
                <?php }?>


                <span><?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['news']->value['list'][$_smarty_tpl->getVariable('smarty')->value['section']['n']['index']]['si_create'],"%Y-%m-%d");?>
</span>
            </div>
            <ul style="position: static">
                <li style="display:none"></li>
                <li><?php echo $_smarty_tpl->tpl_vars['news']->value['list'][$_smarty_tpl->getVariable('smarty')->value['section']['n']['index']]['si_scan'];?>
</li>
                <li><?php echo $_smarty_tpl->tpl_vars['news']->value['list'][$_smarty_tpl->getVariable('smarty')->value['section']['n']['index']]['si_share'];?>
</li>
...
">查看详情>></a>
        ...
        <?php endfor; endif; ?>
        <?php echo smarty_function_page(array('info'=>$_smarty_tpl->tpl_vars['news']->value,'web_url'=>$_smarty_tpl->tpl_vars['web_url']->value,'url'=>"/index.php/Corpinternmsg/index"),$_smarty_tpl);?>
...
?>
            <div class="rec_item">
                ...
                <div>
                    <div><a href="<?php echo $_smarty_tpl->tpl_vars['web_url']->value;?>
/index.php/Jobfairmsg/calendardsiail/id/<?php echo $_smarty_tpl->tpl_vars['jobFair']->value[$_smarty_tpl->getVariable('smarty')->value['section']['calendar']['index']]['jm_id'];?>
