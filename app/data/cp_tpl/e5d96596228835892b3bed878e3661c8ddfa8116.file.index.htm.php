<?php /* Smarty version Smarty-3.1.14, created on 2014-09-23 02:30:59
...
<?php if ($_valid && !is_callable('content_541e4a51ce5099_41541953')) {function content_541e4a51ce5099_41541953($_smarty_tpl) {?>
                    ...
                    <div class="category_info">
                        <div class="category_nav">
                            <ul>
                                ...
                                <li>
                                    <a href="javascript:void(0)">招聘会信息</a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)">实习信息</a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)">职业生涯规划</a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)">就业指导</a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)">创业指导</a>
                                </li>
                            </ul>
                        </div>
