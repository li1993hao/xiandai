<?php /* Smarty version Smarty-3.1.14, created on 2014-09-28 18:41:58
         compiled from "app/tpl/student/favorjobinfo.htm" */ ?>
<?php /*%%SmartyHeaderCode:7509789005427c638f1c0f2-23344132%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ca6d6f2408da534f64d85d0ee8b552db1e408de6' => 
    array (
  ...
  'nocache_hash' => '7509789005427c638f1c0f2-23344132',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.14',
  'unifunc' => 'content_5427c639137dd9_69197531',
  'variables' => 
  array (
    'web_url' => 0,
    'type' => 0,
...
<?php if ($_valid && !is_callable('content_5427c639137dd9_69197531')) {function content_5427c639137dd9_69197531($_smarty_tpl) {?><?php if (!is_callable('smarty_function_page')) include '/Users/haoli/Desktop/www/xiandai/been/View/plugins/function.page.php';
?><!DOCTYPE HTML>
<html>
<head>
...
/common/app/js/ie-css3.js"></script>
    ...
    <style type="text/css">
        ...
        #mytable{width:732px; margin-top:10px;}
        #info th {
...
"><?php echo $_smarty_tpl->tpl_vars['joblist']->value['list'][$_smarty_tpl->getVariable('smarty')->value['section']['jl']['index']]['publishname']['com_name'];?>
                                ...
                                <td>
                                   <div style="height: 20px;margin-bottom: 5px"> <a class="op-del" href="<?php echo $_smarty_tpl->tpl_vars['web_url']->value;?>
...
" >删除</a></div>
                                    <?php if ($_smarty_tpl->tpl_vars['joblist']->value['list'][$_smarty_tpl->getVariable('smarty')->value['section']['jl']['index']]['coll_open_myinfo']==0){?>
                                    <div >信息对企业不可见[<a href="<?php echo $_smarty_tpl->tpl_vars['web_url']->value;?>
...
" style="color: #ff0000; font-size: 12px" >开放</a>]&nbsp;</div>
                                    <?php }else{ ?>
                                    <div>信息对企业可见[<a href="<?php echo $_smarty_tpl->tpl_vars['web_url']->value;?>
...
" style="color: #ff0000; font-size: 12px">关闭</a>]&nbsp;</div>
                                    <?php }?>
                                </td>
                            </tr>
                            <?php endfor; else: ?>
                        ...
                        <br/>
                        <div id="down">
                            <a  id="all-choose" href="javascript:void(0);">全选</a>
                            &nbsp;
                            <a  id="delete-some" href="javascript:void(0);">批量删除</a>
                            &nbsp;
