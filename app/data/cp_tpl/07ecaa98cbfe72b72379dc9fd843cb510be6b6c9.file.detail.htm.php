<?php /* Smarty version Smarty-3.1.14, created on 2014-09-27 13:58:59
         compiled from "app/tpl/employmentpolicy/detail.htm" */ ?>
<?php /*%%SmartyHeaderCode:15774104645426522314ddf0-45593953%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '07ecaa98cbfe72b72379dc9fd843cb510be6b6c9' => 
    array (
      0 => 'app/tpl/employmentpolicy/detail.htm',
      1 => 1411797537,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '15774104645426522314ddf0-45593953',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_54265223224369_79655853',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54265223224369_79655853')) {function content_54265223224369_79655853($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/Users/haoli/Desktop/www/xiandai/been/Smarty/plugins/modifier.date_format.php';
...
/common/app/css/common/detail-360.css" />
    <title>就业政策-<?php echo $_smarty_tpl->tpl_vars['detail']->value['ep_title'];?>
</title>
...
/index.php/employmentpolicy/index">就业政策/</a>
        ...
        <dt><a href="#"><?php echo $_smarty_tpl->tpl_vars['detail']->value['ep_title'];?>
</a></dt>
    </dl>
</div>
<div class="middle">
    ...
    <div class="middle_left">
        <div >
            <p style="float: none; color: #000000; font-size: 18px; text-align: center"><?php echo $_smarty_tpl->tpl_vars['detail']->value['ep_title'];?>
</p>
        </div>
        <div>
            发布时间：<?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['detail']->value['ep_time'],"%Y-%m-%d");?>

            &nbsp; &nbsp; 阅读次数：<?php echo $_smarty_tpl->tpl_vars['detail']->value['ep_browse'];?>
 次
            &nbsp; &nbsp; 分享次数：<?php echo $_smarty_tpl->tpl_vars['detail']->value['ep_share'];?>
 次
        </div>
        <div>
        </div>
        <div  class="content">
            <?php echo $_smarty_tpl->tpl_vars['detail']->value['ep_content'];?>
...
/index.php/employmentpolicy/detail/id/<?php echo $_smarty_tpl->tpl_vars['pre']->value['ep_id'];?>
"><?php echo $_smarty_tpl->tpl_vars['pre']->value['ep_title'];?>
</a>
                <?php }else{ ?>
                没有了！
                <?php }?>
            ...
            <p>
                ...
                <a href="<?php echo $_smarty_tpl->tpl_vars['web_url']->value;?>
/index.php/employmentpolicy/detail/id/<?php echo $_smarty_tpl->tpl_vars['next']->value['ep_id'];?>
"><?php echo $_smarty_tpl->tpl_vars['next']->value['ep_title'];?>
</a>
                <?php }else{ ?>
                没有了！
                <?php }?>
